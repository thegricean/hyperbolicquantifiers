...
def normalize(vector):
    ...
    if normalizer == 0:
        return [float('NaN') for x in vector]
    return [x/normalizer for x in vector]
    
subject_indices = range(0,5)
item_indices = range(5,11)
response_indices = range(11,22)

# Order of the fields
print "workerID,gender,age,income,language,order,food,totalQuant,quantifier,personA,personB,eatenQuant,probability"
