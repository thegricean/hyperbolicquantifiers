...
relevant_fields = ["workerid", "Answer.gender", "Answer.age", "Answer.income", "Answer.nativeLanguage", "Answer.orders", "Answer.personAs", "Answer.personBs","Answer.foods", "Answer.totalQuants", "Answer.eatenQuants", "Answer.preciseEatenQuants", "Answer.affects"]
relevant_indices = []
