...
\includegraphics[width=9.5cm, height=3.6cm]{figure1.pdf}
%\includegraphics[width=10cm, height=4cm]{figure1.pdf}
\tiny 
\caption{Gray (prior) shows prior probabilities of Bob eating various amounts; blue (human) shows participants' interpretations of ``all"; pink (model) shows model predictions.}
\end{minipage}
\hfill
\begin{minipage}[b]{.4\textwidth}
\includegraphics[width=6.5cm, height=3.6cm]{figure2.pdf}
%\includegraphics[width=6.5cm, height=4cm]{figure2.pdf}
\caption{Negative affect conveyed in ``some" v.s. ``all." For both human and model, hyperbolic ``all" conveys more affect than literal ``some."}
\end{minipage}
